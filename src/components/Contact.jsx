    ...
    style={{overscrollBehavior: "none"}}>
        ...
        bg-gradient-to-r from-violet-400 to-pink-100">
            ...
            className="text-center relative flex flex-col items-center justify-center opacity">
                <h1 className="txt-black md:w-[10rem] w-[20rem] lg:scale-[0.4] sm:scale-[0.25]
                scale-[0.07] md:font-bold text-sm sm:text-base leading-none mb-5">
                    Tu negocio al siguiente nivel 
                </h1>
                <p className="text-black lg:w-[40rem] w-[20rem] absolute
                sm:mt-3 mt-1 md:scale-[0.1] scale-[0.068]">
                    ¿Listo para transformar tu presencia en línea? Contáctame hoy y comencemos a construir juntos el futuro digital de tu negocio.
                    Diseño completo de tu sitio web, comodidad de navegacion, animaciones unicas y control de tu negocio en un solo lugar.
