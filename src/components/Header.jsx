        ...
        <header className="absolute w-full z-50 transition-all duration-300">
            ...
            justify-between h-16 md:h-20">
                ...
                <motion.div
                    ...
                    from-gray-500 to-gray-100 flex items-center justify-center text-purple-600 font-bold text-xl mr-3">
                        C
                    </div>
                ...
                <nav className="lg:flex hidden space-x-8">
                    {["Home", "About", "Contact", "Projects", "Experience"].map((item, index) => (
                        <motion.a
                            key={item}
                            ...
                            className="relative text-gray-100 dark:text-gray-200
                            hover:violet-600 dark:hover:text-violet-400 font-medium
                            transition-colors duration-300 group"
                            href="#">
                            {item}
                            <span className="absolute bottom-0 left-0 w-0 h-0.5
                         bg-violet-600 group-hover:w-full transtion-all duration-300"></span>
                        </motion.a>
                    ))}
                </nav>
                ...
                <div className='md:flex hidden items-center space-x-4'>
                    <motion.a
                        ...
                        dark:hover:text-violet-400 transition-colors duration-300' href='https://github.com/ByCristtv'>
                    ...
                    <motion.a
                        ...
                        transition={{ delay: 1.3, duration: 0.8 }}
                        className='text-gray-100 dark:text-gray-300 hover:text-violet-600
                        dark:hover:text-violet-400 transition-colors duration-300' href='https://www.linkedin.com/in/crissr189/?profileId=ACoAADreryEB_tk0IIzDOmJ-mtcqXH8VFUzbMCQ'>
            ...
            transition={{duration:0.5}}
                ...
                <nav className="flex flex-col space-y-3">
                    {["Home", "About", "Contact", "Projects", "Experience"].map
                        ((item) => (
                            <a onClick={toggleMenu} className='text-gray-200 font-medium py-2' key={item} href='#'>
                                {item}
                            </a>
                        ))}
                </nav>
            ...
            <AnimatePresence>
                ...
                items-center justify-center p-4'>
                    ...
                    shadow-xl w-full max-w-md p-6'>
                            <div className='flex justify-between otems-center mb-4'>
                                <h1 className='text-2xl font-bold
                            text-gray-300'>
                                    Get In Touch
                                </h1>
                                <button onClick={closeContacForm}>
                            ...
                            <form className='space-y-4'>
                                ...
                                border-gray-600 rounded-lg focus:ring-violet-500 focus:border-violet-500
                                bg-gray-700' />
                                </div>
                                <div>
                                ...
                                <div>
                                    <label htmlFor="nmssage" className='block text-sm font-medium text-gray-300 mb-1'>
                                        message
                                    </label>
                                    <textarea
                                        rows="4"
                                        id="message"
                                        placeholder='How can I hel you?'
                                        className='w-full px-4 py-2 border
                                border-gray-600 rounded-lg focus:ring-violet-500 focus:border-violet-500
                                bg-gray-700' />
                                </div>
